...
def findColorsMatches(rootDirectoryPath, regexPattern=u"([^&0-9a-zA-Z]|^)(?P<color>#([0-9A-Fa-f]{8}|[0-9A-Fa-f]{6}|[0-9A-Fa-f]{3}))([^0-9A-Za-z]|$)", fileFilterList=[u"*"], fileIgnoreList=[], dirIgnoreList=[], colorsMatch=dict()):
